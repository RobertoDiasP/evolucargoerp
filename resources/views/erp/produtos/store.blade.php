...
<div class="container mt-5">
    ...
    <div class="card p-2">
        <div class="card-header">
            <h6 class="text-center">Cadastro de Produto</h6>
        </div>
        <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="hidden" name="imobilizado" value="0">
                            <input type="checkbox" class="form-check-input" id="imobilizado" name="imobilizado" value="1">
                        </div>
                    </div>
                </div>
